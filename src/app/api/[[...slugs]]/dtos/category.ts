...
export const UpdateCategoryUsecasePrompt = t.Object(
  {
    category_id: t.String(),
    category_name: t.String(),
  }
...
export const UpdateCategoryUsecaseResponse = t.Object(
  {
    category_id: t.String(),
    category_name: t.String(),
    updated_at: t.Date(), // ถ้ามีใน entity ด้วย
...
export type UpdateCategoryUsecasePrompt = Static<typeof UpdateCategoryUsecasePrompt>
export type CategoryUsecaseResponseType = Static<typeof CategoryUsecaseResponse>;
export type UpdateCategoryUsecaseResponseType = Static<typeof UpdateCategoryUsecaseResponse>;
